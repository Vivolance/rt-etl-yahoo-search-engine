...
class TestSatusDTO:
    ...
    def test_create_job(self, user_id: str, expected_result: JobsDTO) -> None:
        # use patch with side_effect to control generate 2 unique uuid as required.
        with freeze_time("2024-10-1 12:00:00"), patch(
            "src.models.dto_data_classes.status_dto.uuid.uuid4",
            side_effect=[dummy_uuid, dummy_job_uuid],
        ):
